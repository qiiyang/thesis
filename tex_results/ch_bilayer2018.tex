...
\end{figure} %
%
Their bulk magnetic properties were studied with a superconducting quantum interference device (SQUID) magnetometer. Examples are presented in figures~\ref{fig:bilayer2018_mvt}~\&~\ref{fig:bilayer2018_mvh} for sample S2.\footnote{Error bars in this chapter represent 95\% confidence intervals.}%
\begin{figure}[ht]%
    \centering%
