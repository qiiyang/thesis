...
\chapter[Europium (II) Sulfide (EuS): An Insulating Ferromagnet]{Europium (II) Sulfide (EuS): An Insulating Ferromagnet\protect\footnote{A part of this chapter is adapted from Appl. Phys. Lett. 104, 082402 (2014) \cite{EuS_PLD}, with permission from AIP Publishing.}}
\input{ch_EuS.tex}

\chapter{Bismuth Selenide (Bi$_2$Se$_3$) on Europium Sulfide}
...

\chapter{Bismuth Doped Antimony Telluride (Bi$_x$Sb$_{1-x}$)$_2$Te$_3$ on Europium Sulfide}
...
