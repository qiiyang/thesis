...
\label{ch:EuS}\input{ch_EuS.tex}

\chapter{Bismuth(III) Selenide on Europium(II) Sulfide}
\label{ch:bilayer2014}\input{ch_bilayer2014.tex}


\chapter{Bismuth Doped Antimony(III) Telluride on Europium(II) Sulfide}
\label{ch:bilayer2018}\footnote[2]{A part of this chapter is adapted from ~\cite{bilayer2018}~\fullcite{bilayer2018}, with permission of the publisher. Copyright (2018) by the
