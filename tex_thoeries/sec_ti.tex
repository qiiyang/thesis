...
\end{equation}
Therefore, albeit the two bands are otherwise degenerate at the Dirac point, $E_1(\vec{k}_0) = E_2(\vec{k}_0)$, any scattering between the bands may open a gap $\Delta{}E = \abs{w(\vec{k}_0)}$.
