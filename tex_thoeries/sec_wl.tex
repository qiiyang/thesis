...
\end{equation}%
This results in a reduction of conductivity, or an increase in sheet resistance, as the temperature decreases. When the spin-orbit coupling is strong, on the other hand, the correction term due to weak anti-localization results in an increase of conductivity, or a reduction in sheet resistance, as the temperature lowers (ref.~\cite{bergmann1984}: figure~4.1).
