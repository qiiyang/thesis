...
\begin{enumerate}[label={\alph*)}]
    ...
    \item The sample has uniform 2D resistivity everywhere.\label{it:vdp3}
    \item The sample is singly connected, namely does not have isolated holes.\label{it:vdp4}
\end{enumerate}%
...
\begin{figure}[ht]%
    ...
    \caption[A typical square van der Pauw pattern]{\label{fig:vdp_square}A typical square van der Pauw pattern used for measuring samples presented in later chapters.}%
\end{figure}%
...
Comparing the sample geometry to 