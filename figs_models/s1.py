...
if __name__ == '__main__':
    ...
    sub.plot(x_trans(data["T"]), y_trans(data["R"]), color=pal.s1, marker="x", markerfacecolor="none", markersize=marker_size, linestyle="none", label="S1")
    ...
    fig.savefig(r's1.pdf', format='pdf')