...
if __name__ == '__main__':
    ...
    sub.plot(x_trans(data["T"]), y_trans(data["R"]), color=pal.s2, marker="x", markerfacecolor="none", markersize=marker_size, linestyle="none", label="S2")
    ...
    fig.savefig(r's2.pdf', format='pdf')